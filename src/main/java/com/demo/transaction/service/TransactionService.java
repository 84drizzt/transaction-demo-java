...
public class TransactionService {
    ...
    @Transactional(readOnly = true)
    public Page<TransactionDTO> getTransactionsByParameters(TransactionDTO searchDTO, Pageable pageable) {
        ...
        return transactionRepository.findAll(builder.build(), pageable)
                .map(this::convertToDTO);
    }
